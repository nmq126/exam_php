	...
	(function( $ ){
		 $.fn.multipleInput = function() {
			  return this.each(function() {
				   // list of emails addresses as unordered list
				   $list = $('<ul/>');
				   // input
				   var $input = $('<input type="emails" id="email_search" class="email_search multiemail"/>').keyup(function(event) {
						if(event.which == 13 || event.which == 32 || event.which == 188) {
							 ...
							 $list.append($('<li class="multipleInput-emails"><span>' + val + '</span></li>')
							 ...
							 $(this).val('');
								...
								alert('Please enter valid emails id, Thanks!');
							  }
						}
				   });
				   // container div
